...
/*   Updated: 2017/08/09 16:56:05 by svelhinh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "nm.h"

static void	set_sym_values(t_nlist_64 array_elem,
	char *stringtable, t_sym **current)
{
	...
	hex_value = ft_value_to_hex_64(array_elem.n_value);
...
t_sym		**get_syms_64(int nsyms, int stroff, char *ptr, t_nlist_64 *array)
{
	int				i;
	char			*stringtable;
	t_sym			**first;
