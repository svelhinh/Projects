...
function	set_products()
{
	...
	$petitchably = array("nom" => "Petit chablis", "tags" => "blanc, bourgogne", "image" => 'img/vins/blanc/blanc-bourgogne-petitchablis.jpg',  "description" => "Pas si petit. 2014, Petit Chablis AOC",  "prix" => "11", "quantite" => "20");
	...
	$fondcroze = array("nom" => "Fond croze", "tags" => "blanc, rhone", "image" => 'img/vins/blanc/blanc-rhone-fondcroze.jpg',  "description" => "Cuvee Confidence 2014",  "prix" => "9", "quantite" => "20");
	...
	$winenote = array("nom" => "Wine note", "tags" => "rose, bordeaux", "image" => 'img/vins/rose/rose-bordeaux-winenote.jpg',  "description" => "Bordeaux rose, assemblage de Merlot et de Cabernet Franc",  "prix" => "5", "quantite" => "20");
